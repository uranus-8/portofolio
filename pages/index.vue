    ...
    <div class="section pad-20 section-conts" id="about">
      <div class="aboutsec">
        ...
        <div class="">
          <div class="pb-5">
            <p>
              これまでに、UI/UXデザイン、Webデザイン、アニメーションの制作に携わり、フロントエンドエンドエンジニアリングの開発にも参画してきました。
              <br>さらに、チームマネジメントやディレクション（企画・提案）にも経験があります。
            </p>
            <p>
              今後は、イメージを形にすることに特化し、ストーリー性や没入感の高いコンテンツを作り出すこと、直感的な操作感のあるソフトウェアの開発に注力していきたいと考えています。
